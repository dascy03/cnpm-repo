...
const BuyPage = () => {
    ...
    return (
        ...
        <section className="grid grid-cols-5 mt-24 gap-4 h-screen bg-white">
          <div className="col-start-2 col-span-2 bg-white p-4">
              <div class="w-full flex items-center ">
                ...
                <div class="relative  ">
                  <input
                    type="text"
                    class="border border-gray-500 bg-white h-12 w-64 px-4 pr-4 rounded-xl text-sm focus:outline-none mt-2"
                  />
                </div>
              </div>
              <div class="mt-8 w-full flex items-center ">
                ...
                <div class="relative" >
                  <select class="border border-gray-500 bg-white h-12 w-64 px-4 pr-4 rounded-xl text-xl focus:outline-none mt-2">
                    <option>BKPay</option>
                    <option>Momo</option>
          ...
          <div className="col-span-1 mt-5 bg-[#C4E4F3] h-40">
            <h1 class="font-bold text-xl mt-6 text-center">
              HÓA ĐƠN
            </h1>
            <div class="grid grid-cols-3 mt-8">
              <p class="col-span-1 text-sm  ml-6">
                Đơn giá
              </p>
            ...
            <div class="grid grid-cols-3 mt-3">
              <p class="col-span-1  font-bold ml-6">
                Tổng
              </p>
              <p class=" col-span-2  text-right font-bold mr-6">
                400.000 đồng
              </p>
            </div>
